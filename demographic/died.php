...
$b = mysqli_query($dbconn, "SELECT * FROM charts where area = '$area';");
  ...
  <body class="u-body u-xl-mode"><header class="u-align-center-sm u-align-center-xs u-clearfix u-gradient u-header u-sticky u-sticky-2533 u-header" id="sec-7b81"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-2" id="sec-4864">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-custom-font u-font-roboto u-text u-text-default u-text-1"><?php echo $area_name;?> облысы бойынша қайтыс болған адамдар саны</h3>
    ...
    <div style="margin-bottom: 75px; margin-top: 80px;">
      <h3  class="u-custom-font u-font-roboto u-text u-text-default u-text-1"><?php echo $area_name;?> облысы бойынша қайтыс болған адамдар санының динамикалық графигі</h3>
      <?php
